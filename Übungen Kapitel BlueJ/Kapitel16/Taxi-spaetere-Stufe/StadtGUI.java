...
{
    // die Dimensionen der GUI
    public static final int STADTANSICHT_BREITE = 600;
    public static final int STADTANSICHT_HOEHE = 600;
    private Stadt stadt;
    ...
    public StadtGUI(Stadt stadt)
    {
        ...
        setTitle("Taxiville");
        setSize(STADTANSICHT_BREITE, STADTANSICHT_HOEHE);
        setVisible(true);
    ...
    {
        stadtansicht.zeichnenVorbereiten();
        Iterator<Object> gegenstaende = stadt.gibGegenstaende();
        ...
        public void paintComponent(Graphics g)
        {
            if(stadtImage != null) {
                ...
                if(groesse.equals(aktuelleGroesse)) {
                    ...
                    // das bisherige Bild neu skalieren
                    g.drawImage(stadtImage, 0, 0, aktuelleGroesse.width, aktuelleGroesse.height, null);
